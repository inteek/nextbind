...
public partial class InteekServiceEntities : DbContext
{
    ...
    public virtual DbSet<tb_AsociarGrupoUsuario> tb_AsociarGrupoUsuario { get; set; }

    public virtual DbSet<tb_Bitacora> tb_Bitacora { get; set; }

    public virtual DbSet<tb_CausaSolucion> tb_CausaSolucion { get; set; }

    public virtual DbSet<tb_DescripcionBitacora> tb_DescripcionBitacora { get; set; }

    public virtual DbSet<tb_Dispositivo> tb_Dispositivo { get; set; }

    public virtual DbSet<tb_Documento> tb_Documento { get; set; }

    public virtual DbSet<tb_Estatus> tb_Estatus { get; set; }

    public virtual DbSet<tb_Grupo> tb_Grupo { get; set; }

    public virtual DbSet<tb_Perfil> tb_Perfil { get; set; }

    public virtual DbSet<tb_Prioridad> tb_Prioridad { get; set; }

    public virtual DbSet<tb_Solucion> tb_Solucion { get; set; }

    public virtual DbSet<tb_Ticket> tb_Ticket { get; set; }

    public virtual DbSet<tb_TicketBitacora> tb_TicketBitacora { get; set; }

    public virtual DbSet<tb_TicketDocumento> tb_TicketDocumento { get; set; }

    public virtual DbSet<tb_TicketSolucion> tb_TicketSolucion { get; set; }

    public virtual DbSet<tb_TipoServicio> tb_TipoServicio { get; set; }

    public virtual DbSet<tb_TipoServicioGrupo> tb_TipoServicioGrupo { get; set; }
    ...
    public virtual ObjectResult<ConsultaTicketsNoAsignados_Result> ConsultaTicketsNoAsignados(Nullable<int> id_usuario, Nullable<int> id_grupo)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ConsultaTicketsNoAsignados_Result>("ConsultaTicketsNoAsignados", id_usuarioParameter, id_grupoParameter);
    }
    ...
    public virtual int AsignaGrupoUsuario(Nullable<int> id_usuario, Nullable<int> id_area)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AsignaGrupoUsuario", id_usuarioParameter, id_areaParameter);
    }
    ...
    public virtual int RegistraBitacora(Nullable<int> id_cliente, Nullable<System.DateTime> fecha, Nullable<int> desc, Nullable<int> estatus, Nullable<int> id_ticket)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("RegistraBitacora", id_clienteParameter, fechaParameter, descParameter, estatusParameter, id_ticketParameter);
    }
